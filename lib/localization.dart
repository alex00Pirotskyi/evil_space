...
class LocalizationController extends ChangeNotifier {
  ...
  static const Map<String, Map<String, String>> strings = {
    'en': {
      ...
      'booking_title_today': 'GET A DESK TODAY',
      'booking_title_tomorrow': 'GET A DESK TOMORROW',
      'free_short': 'AVAILABLE',
      ...
      'booking_tg_copy':
          'ONE TAP. TELEGRAM WILL IDENTIFY YOU — NO NAME OR PHONE NEEDED.',
      'booking_or': 'OR',
      ...
      'prices_title': 'SIMPLE PRICES',
      'about_title': 'THE SPACE',
      'amenity_chairs': 'KOREAN ERGO',
      'amenity_wifi': '800 MBPS',
      'amenity_desks': '140 × 70 CM',
      'amenity_air': 'A/C',
      'amenity_coffee': 'COFFEE BAR',
      'amenity_panels': 'ACOUSTIC',
      'amenity_chairs_detail': 'Korean ergonomic chairs',
      'amenity_wifi_detail': 'Fiber Wi-Fi, up to 800 Mbps',
      'amenity_desks_detail': '140 by 70 centimeter desks',
      'amenity_air_detail': 'Air conditioning',
      'amenity_coffee_detail': 'Fresh coffee at the café',
      'amenity_panels_detail': 'Acoustic panels between desks',
      'promo_label': 'PROMO',
    ...
    'ru': {
      ...
      'booking_today': 'СЕГОДНЯ',
      'booking_tomorrow': 'ЗАВТРА',
      'booking_title_today': 'ЗАБРОНИРОВАТЬ СТОЛ НА СЕГОДНЯ',
      'booking_title_tomorrow': 'ЗАБРОНИРОВАТЬ СТОЛ НА ЗАВТРА',
      'free_short': 'СВОБ.',
      ...
      'booking_tg_copy':
          'ОДИН КЛИК. TELEGRAM ОПРЕДЕЛИТ ВАС — ИМЯ И ТЕЛЕФОН НЕ НУЖНЫ.',
      'booking_or': 'ИЛИ',
      ...
      'prices_title': 'ПРОСТЫЕ ЦЕНЫ',
      'about_title': 'ПРОСТРАНСТВО',
      'amenity_chairs': 'ЭРГОКРЕСЛА',
      'amenity_wifi': '800 МБИТ/С',
      'amenity_desks': '140 × 70 СМ',
      'amenity_air': 'КОНДИЦИОНЕР',
      'amenity_coffee': 'КОФЕ-БАР',
      'amenity_panels': 'АКУСТИКА',
      'amenity_chairs_detail': 'Корейские эргономичные кресла',
      'amenity_wifi_detail': 'Оптоволоконный Wi-Fi до 800 Мбит/с',
      'amenity_desks_detail': 'Рабочие столы 140 на 70 сантиметров',
      'amenity_air_detail': 'Кондиционер',
      'amenity_coffee_detail': 'Кофе в кафетерии',
      'amenity_panels_detail': 'Акустические панели между столами',
      'promo_label': 'АКЦИЯ',
      'price_day_pass': 'ДЕНЬ',
    ...
    'vi': {
      ...
      'booking_today': 'HÔM NAY',
      'booking_tomorrow': 'NGÀY MAI',
      'booking_title_today': 'ĐẶT BÀN HÔM NAY',
      'booking_title_tomorrow': 'ĐẶT BÀN NGÀY MAI',
      'free_short': 'TRỐNG',
      ...
      'booking_save_copy':
          'Chỉ lưu liên hệ trên thiết bị này để đặt bàn một chạm lần sau.',
      'booking_save': 'LƯU',
      ...
      'about_title': 'KHÔNG GIAN',
      'amenity_chairs': 'GHẾ ERGO HÀN',
      'amenity_wifi': '800 MBPS',
      'amenity_desks': '140 × 70 CM',
      'amenity_air': 'MÁY LẠNH',
      'amenity_coffee': 'QUẦY CÀ PHÊ',
      'amenity_panels': 'VÁCH TIÊU ÂM',
      'amenity_chairs_detail': 'Ghế công thái học Hàn Quốc',
      'amenity_wifi_detail': 'Wi-Fi cáp quang lên đến 800 Mbps',
      'amenity_desks_detail': 'Bàn làm việc 140 × 70 cm',
      'amenity_air_detail': 'Máy lạnh',
      'amenity_coffee_detail': 'Cà phê tại quầy',
      'amenity_panels_detail': 'Vách tiêu âm giữa các bàn',
      'promo_label': 'KHUYẾN MÃI',
